            ...
            <div class="col-sm-12 col-lg-12">
                <div class="btn-group" data-toggle="buttons">
                    <label class="btn btn-default span-btn monthly " v-bind:class="{active: isActive==1}" @click="number">
                        <input type="radio" name="options" id="option2" autocomplete="off"  value="monthly" checked v-model="selected"> Monthly Tariff
                    </label>
                    <label class="btn btn-default span-btn yearly" v-bind:class="{active: isActive==0}" @click="numbers">
                        <input type="radio" name="options" id="option3" autocomplete="off" value="yearly" v-model="selected">  Yearly Tariff
                    </label>
                </div>
            </div>
