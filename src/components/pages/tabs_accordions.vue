        ...
        <div class="col-md-6">
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    <b-btn  v-b-tooltip.hover.right variant="info" class="mb-3 btn-lg" title="Tooltip in right ">Right </b-btn>
                    ...
                    <div class="bs-example">
                        <ul class="tooltip-examples list-inline">
                            <a  v-b-tooltip.hover.top  title="hi" class=" ml-3 mr-3">Tooltip</a>
                            <a  v-b-tooltip.hover.top  title="Hellio!!" class=" ml-3 mr-3">Small tooltip</a>
